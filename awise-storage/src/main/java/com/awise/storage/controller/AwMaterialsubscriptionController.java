...
import com.awise.storage.service.IAwMaterialsubscriptionService;
 ...
 */
@RestController
@RequestMapping("/storage/materialsubscription")
public class AwMaterialsubscriptionController extends BaseController
{
     ...
     * 查询申购材料列表
     */
    @PreAuthorize("@ss.hasPermi('storage:materialsubscription:list')")
    @GetMapping("/list")
     ...
     * 导出申购材料列表
     */
    @PreAuthorize("@ss.hasPermi('storage:materialsubscription:export')")
     ...
     * 获取申购材料详细信息
     */
    @PreAuthorize("@ss.hasPermi('storage:materialsubscription:query')")
     ...
     * 新增申购材料
     */
    @PreAuthorize("@ss.hasPermi('storage:materialsubscription:add')")
     ...
     * 修改申购材料
     */
    @PreAuthorize("@ss.hasPermi('storage:materialsubscription:edit')")
     ...
     * 删除申购材料
     */
    @PreAuthorize("@ss.hasPermi('storage:materialsubscription:remove')")
