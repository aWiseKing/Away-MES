<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="productdeliveryformList" @selection-change="handleSelectionChange">
      <el-table-column type="selection" width="55" align="center" />
      <el-table-column label="出库单编号" align="center" prop="deliveryNoteID" />
      <el-table-column label="出库日期" align="center" prop="warehousingDate" width="180">
      ...
      <el-table-column label="状态" align="center" prop="status">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.aw_produce_productdeliveryform_status" :value="scope.row.status"/>
        </template>
      </el-table-column>
...
<script>
import { listProductdeliveryform, getProductdeliveryform, delProductdeliveryform, addProductdeliveryform, updateProductdeliveryform } from "@/api/produce/productdeliveryform";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除产品出库单编号为"' + deliveryNoteIDs + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('produce/productdeliveryform/export', {
        ...this.queryParams
