    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="primary" plain icon="el-icon-plus" size="mini" @click="handleAdd"
          v-hasPermi="['produce:MaterialListOfTechnology:add']">新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="success" plain icon="el-icon-edit" size="mini" :disabled="single" @click="handleUpdate"
          v-hasPermi="['produce:MaterialListOfTechnology:edit']">修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="danger" plain icon="el-icon-delete" size="mini" :disabled="multiple" @click="handleDelete"
          v-hasPermi="['produce:MaterialListOfTechnology:remove']">删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="warning" plain icon="el-icon-download" size="mini" @click="handleExport"
          v-hasPermi="['produce:MaterialListOfTechnology:export']">导出</el-button>
      </el-col>
      <right-toolbar :showSearch.sync="showSearch" @queryTable="getList"></right-toolbar>
    </el-row>

    <el-table v-loading="loading" :data="MaterialListOfTechnologyList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button size="mini" type="text" icon="el-icon-view" @click="handleView(scope.row)"
            v-hasPermi="['produce:MaterialListOfTechnology:edit']">查看</el-button>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px" :disabled="view_open">
        <el-row :gutter='12'><el-col :span='12'> <el-form-item label="工艺编号" prop="processingTechnologyID">
            ...
            <el-form-item label="材料名称" prop="name">
              <el-input v-model="clickBasicinformationofmaterials.name" disabled placeholder="请输入材料名称" />
            </el-form-item></el-col><el-col :span='12'>
            <el-form-item label="材料密度" prop="materialDensity">
              <el-input v-model="clickBasicinformationofmaterials.materialDensity" disabled placeholder="请输入材料密度" />
            </el-form-item></el-col></el-row><el-row :gutter='12'><el-col :span='12'>
            <el-form-item label="类别名称" prop="typeName">
              <el-input v-model="clickBasicinformationofmaterials.typeName" disabled placeholder="请输入类别名称" />
            </el-form-item></el-col><el-col :span='12'>
            <el-form-item label="规格型号" prop="specificationModel">
              <el-input v-model="clickBasicinformationofmaterials.specificationModel" disabled placeholder="请输入规格型号" />
            </el-form-item></el-col></el-row><el-row :gutter='12'><el-col :span='12'>
...
<script>
import { listMaterialListOfTechnology, getMaterialListOfTechnology } from "@/api/produce/MaterialListOfTechnology";
import { delProcessrequirementmateriallist, addProcessrequirementmateriallist, updateProcessrequirementmateriallist } from "@/api/produce/processrequirementmateriallist";
import { listBasicinformationofmaterials, getBasicinformationofmaterials } from "@/api/storage/basicinformationofmaterials"
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除需求材料编号为"' + ids + '"的数据项？').then(function () {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('produce/MaterialListOfTechnology/export', {
        ...this.queryParams
