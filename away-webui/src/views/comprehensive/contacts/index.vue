<template>
  <div class="app-container">
    ...
    >
      ...
      <!-- <el-form-item label="删除否 0为存在 1为删除" prop="isDel">
        <el-input
          v-model="queryParams.isDel"
          placeholder="请输入删除否 0为存在 1为删除"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item> -->
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['common:contacts:test']"
          >测试</el-button
        >
      </el-col>
      <right-toolbar
    ...
    >
      ...
      <!-- <el-table-column label="删除否 0为存在 1为删除" align="center" prop="isDel" /> -->
      <el-table-column
        label="操作"
        align="center"
...
存储  联系人姓名，电话，部门，职位对话框 -->
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="联系人所属的定位1" prop="location">
          <el-select v-model="form.location" placeholder="请选择">
            <el-option
              v-for="(item, index) in contactLocations"
              :key="index"
              :label="item.label"
              :value="item.value"
            >
...
存储  联系人姓名，电话，部门，职位列表 */
    ...
    handleDelete(row) {
      ...
      this.$modal
        .confirm(
          '是否确认删除联系人信息存储合作方的联系人的联系信息存储  联系人姓名，电话，部门，职位编号为"' +
            ids +
            '"的数据项？'
        )
        .then(function () {
