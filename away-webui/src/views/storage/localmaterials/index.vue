<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="localmaterialsList" @selection-change="handleSelectionChange">
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除本地材料实时库存编号为"' + ids + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('storage/localmaterials/export', {
        ...this.queryParams
