  ...
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['storage:purchaserequisition:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['storage:purchaserequisition:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['storage:purchaserequisition:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['storage:purchaserequisition:export']"
        >导出</el-button>
      </el-col>
      <right-toolbar :showSearch.sync="showSearch" @queryTable="getList"></right-toolbar>
    </el-row>

    <el-table v-loading="loading" :data="purchaserequisitionList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="申购日期" align="center" prop="subscriptionDate" width="180">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.subscriptionDate, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="申购人" prop="requisitioner">
          <el-input v-model="form.requisitioner" placeholder="请输入申购人" />
        </el-form-item>
        <el-form-item label="申购日期" prop="subscriptionDate">
          <el-date-picker clearable
        ...
        <el-form-item label="核准人" prop="approver">
          <el-input v-model="form.approver" placeholder="请输入核准人" />
        </el-form-item>
...
<script>
import { listPurchaserequisition, getPurchaserequisition, delPurchaserequisition, addPurchaserequisition, updatePurchaserequisition } from "@/api/storage/purchaserequisition";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除申购单编号为"' + subscribeIDs + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('storage/purchaserequisition/export', {
        ...this.queryParams
