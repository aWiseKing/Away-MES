<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="toolinformationList" @selection-change="handleSelectionChange">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="刀具规格" prop="specificationsID">
          <el-select v-model="form.specificationsID" placeholder="请输入刀具规格">
            <el-option
...
<script>
import { listToolinformation, getToolinformation, delToolinformation, addToolinformation, updateToolinformation } from "@/api/storage/toolinformation";
...
export default {
  ...
  methods: {
    ...
    /** 查询刀具分类信息 **/
    getlistToolclassification(){
      listToolclassification({}).then(response => {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除刀具信息编号为"' + ids + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('storage/toolinformation/export', {
        ...this.queryParams
