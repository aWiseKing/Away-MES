    ...
    <el-row :gutter="10" class="mb8" >
      ...
      <el-col :span="1.5">
        <el-button type="warning" plain icon="el-icon-download" size="mini" @click="handleExport"
          v-hasPermi="['storage:matloutbounddet:export']">导出</el-button>
      </el-col>
      <right-toolbar :showSearch.sync="showSearch" @queryTable="getList"></right-toolbar>
    </el-row>

    <el-table v-loading="loading" :data="matloutbounddetList" @selection-change="handleSelectionChange">
...
<script>
import { listMatloutbounddet, getMatloutbounddet } from "@/api/storage/matloutbounddet";
...
export default {
 ...
 async   getListMateriallistoftechnology(processingTechnologyID) {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除材料出库详细编号为"' + ids + '"的数据项？').then(function () {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('storage/matloutbounddet/export', {
        ...this.queryParams
