<template>
  <div class="app-container">
        ...
        <el-col :span="21">
          <div style="overflow-x: auto;scrollbar-width: none; white-space: nowrap;">
            <el-form-item label="质检名称" prop="nameOfQualityInspection">
              <el-input v-model="queryParams.nameOfQualityInspection" placeholder="请输入质检名称" clearable
                @keyup.enter.native="handleQuery" />
            </el-form-item>
            <el-form-item label="质检类别" prop="qualityInspectionCategory">
              <el-select v-model="queryParams.qualityInspectionCategory" placeholder="请选择质检类别" clearable
                @keyup.enter.native="handleQuery">
                <el-option v-for="item in qualityInspectionCategory_dict" :key="item.key" :label="item.value"
                  :value="item.key">
                </el-option>
              </el-select>
            </el-form-item>
            <el-form-item label="任务编号" prop="productionTasksID">
              <el-input v-model="queryParams.productionTasksID" placeholder="请输入任务编号" clearable
                @keyup.enter.native="handleQuery" />
            </el-form-item>
            <el-form-item label="工序编号" prop="processingprocessID">
              <el-input v-model="queryParams.processingprocessID" placeholder="请输入工序编号" clearable
                @keyup.enter.native="handleQuery" />
            </el-form-item>
            <el-form-item label="检测日期" prop="testDate">
              <el-date-picker clearable v-model="queryParams.testDate" type="date" value-format="yyyy-MM-dd"
                placeholder="请选择检测日期">
              </el-date-picker>
            </el-form-item>
            <el-form-item label="检测结果" prop="testResult">
              <el-select v-model="queryParams.testResult" placeholder="请选择检测结果" clearable
                @keyup.enter.native="handleQuery">
                <el-option v-for="item in testResult_option" :key="item.key" :label="item.value" :value="item.key">
                </el-option>
              </el-select>
            </el-form-item>
            <el-form-item label="检测人员" prop="testingPersonnel">
              <el-input v-model="queryParams.testingPersonnel" placeholder="请输入检测人员" clearable
                @keyup.enter.native="handleQuery" />
            </el-form-item>
          </div>
        </el-col>
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="primary" plain icon="el-icon-plus" size="mini" @click="handleAdd"
          v-hasPermi="['quality:processinspection:add']">新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="success" plain icon="el-icon-edit" size="mini" :disabled="single" @click="handleUpdate"
          v-hasPermi="['quality:processinspection:edit']">修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="danger" plain icon="el-icon-delete" size="mini" :disabled="multiple" @click="handleDelete"
          v-hasPermi="['quality:processinspection:remove']">删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="warning" plain icon="el-icon-download" size="mini" @click="handleExport"
          v-hasPermi="['quality:processinspection:export']">导出</el-button>
      </el-col>
    ...
    <el-dialog :title="title" :visible.sync="open" width="900px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px" :disabled="open_view == true ? true : false">
        <el-row :gutter="12">
          <el-col :span="12">
            <el-form-item label="质检名称" prop="nameOfQualityInspection">
        ...
        <el-row :gutter="12">
          <el-col :span="12">
            <el-form-item label="任务单">
              <el-select v-model="productiontasklist" placeholder="请选择任务单" filterable
                @focus="getListProductiontasklist()">
                <el-option v-for="item in productiontasklist_list" :key="item.id" :label="item.referred" :value="item.id">
                </el-option>
              </el-select>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="任务" prop="productionTasksID">
              <el-select v-model="form.productionTasksID" :disabled="productiontasklist == null ? true : false"
                placeholder="请选择任务" filterable @focus="getListProductiontasks()">
                <el-option v-for="item in productiontasks_list" :key="item.id" :label="item.id" :value="item.id"
          ...
          <el-col :span="12">
            <el-form-item label="工序" prop="processingprocessID">
              <el-select v-model="form.processingprocessID" :disabled="processingTechnologyID == null ? true : false"
                placeholder="请选择工序" filterable @focus="getListProcessingprocess()">
                <el-option v-for="item in processingprocess_list" :key="item.id" :label="item.name" :value="item.id">
                </el-option>
              </el-select>
            </el-form-item>
          </el-col>
        ...
        <el-row :gutter="12">
          <el-col :span="12">
            <el-form-item label="检测日期" prop="testDate">
              <el-date-picker clearable v-model="form.testDate" type="date" value-format="yyyy-MM-dd"
                placeholder="请选择检测日期">
              </el-date-picker>
            </el-form-item>
          </el-col>
