<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="finishedproductinspectionList" @selection-change="handleSelectionChange">
...
<script>
import { listFinishedproductinspection, getFinishedproductinspection, delFinishedproductinspection, addFinishedproductinspection, updateFinishedproductinspection } from "@/api/quality/finishedproductinspection";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除成品检验编号为"' + ids + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('quality/finishedproductinspection/export', {
        ...this.queryParams
